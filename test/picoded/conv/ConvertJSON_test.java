...
public class ConvertJSON_test {
	...
	public void basicListConversion() {
		...
		assertEquals("[\"Hello\",\"WORLD\"]",
				(tStr = ConvertJSON.fromList(tList)));
	...
	public void basicToObjectConversion() {
		object = ConvertJSON
				.toObject("{\"Hello\":\"WORLD\",\"WORLD\":\"Hello\"}");
	...
	public void basicToStringArrayConversion() {
		objectArray = ConvertJSON
				.toStringArray("[\"Hello\",\"WORLD\",\"WORLD\",\"Hello\"]");
		assertEquals("[Hello, WORLD, WORLD, Hello]",
	...
	public void basicToDoubleArrayConversion() throws IOException {
		...
		objectArray = ArrayUtils.toObject(ConvertJSON
				.toDoubleArray("[12.1, 12.9, 23.9, 4.0]"));
		assertEquals("[12.1, 12.9, 23.9, 4.0]",
				Arrays.deepToString(objectArray));
		objectArray = ArrayUtils.toObject(ConvertJSON
				.toDoubleArray("[-7.1, 22.234, 86.7, -99.02]"));
		assertEquals("[-7.1, 22.234, 86.7, -99.02]",
				Arrays.deepToString(objectArray));
		objectArray = ArrayUtils.toObject(ConvertJSON
				.toDoubleArray("[-1.0, 2.9]"));
	...
	public void basicToIntArrayConversion() throws IOException {
		...
		assertEquals("[]", Arrays.deepToString(objectArray));
		objectArray = ArrayUtils.toObject(ConvertJSON
				.toIntArray("[121, 129, 239, 40]"));
		assertEquals("[121, 129, 239, 40]", Arrays.deepToString(objectArray));
		objectArray = ArrayUtils.toObject(ConvertJSON
				.toIntArray("[-71, 22234, 867, -9902]"));
		assertEquals("[-71, 22234, 867, -9902]",
				Arrays.deepToString(objectArray));
	...
	public void basicToObjectArrayConversion() {
		objectArray = ConvertJSON
				.toObjectArray("[\"Hello\",\"WORLD\",\"WORLD\",\"Hello\"]");
		assertEquals("[Hello, WORLD, WORLD, Hello]",
				Arrays.deepToString(objectArray));
	...
	public void testStringArrayToString() throws IOException {
		...
		assertEquals("[a,b,c]",
				ConvertJSON.fromArray(new String[] { "a", "b", "c" }));
	...
	public void testIntArrayToString() throws IOException {
		...
		assertEquals("[-7,22,86,-99]",
				ConvertJSON.fromArray(new int[] { -7, 22, 86, -99 }));
		...
		assertEquals("[-7,22,86,-99]",
				ConvertJSON.fromArray(new int[] { -7, 22, 86, -99 }).toString());
	}
	...
	public void testDoubleArrayToString() throws IOException {
		...
		assertEquals("[-7.1,22.234,86.7,-99.02]",
				ConvertJSON
						.fromArray(new double[] { -7.1, 22.234, 86.7, -99.02 }));
		...
		assertEquals(
				...
				ConvertJSON.fromArray(
						new double[] { -7.1, 22.234, 86.7, -99.02 }).toString());
	}
}
