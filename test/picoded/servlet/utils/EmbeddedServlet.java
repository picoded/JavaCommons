...
public class EmbeddedServlet {
	...
	public void start() throws LifecycleException {
		if (_tomcat != null) {
			...
			throw new RuntimeException("Tomcat instance is null");
		}
	}
	...
	private EmbeddedServlet withContextRoot(String contextRootName, File contextRootFolder) {
		if (_tomcat != null) {
