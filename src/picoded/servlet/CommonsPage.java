...
//				"api.js");
	...
	public String buildApiScript() throws IOException {
		...
		FileUtil.writeStringToFile_ifDifferant(new File(getContextPath() + "/api.js"), apiJS, null /*"UTF-8"*/);
		return apiJS;
	}
	...
	public void initializeContext() throws Exception {
		...
		if(this._commandLineInitialized){
			boolean ignorePageBuilderCLI = JConfig().getBoolean("developersMode.PageBuilder_ignoreCommandLineInitialized", false);
