...
public class DStackConfigLoader {
	...
	private static JSql generateJSql(Object inConfigMap) {
		...
		GenericConvertMap<String, Object> configMap = GenericConvert
			.toGenericConvertStringMap(inConfigMap);
	...
	public static DStack generateDStack(Object stackConfig) {
		...
		if (stackOptionList == null) {
			throw new InvalidParameterException(
				"Unexpected stackConfig, should be list<map<string,object>> compatible");
		}
		...
		for (Object stackOption : stackOptionList) {
			...
			if (optionMap == null) {
				throw new InvalidParameterException("Unexpected stackOption map found in list : "
					+ stackOption);
			}
