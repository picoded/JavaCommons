...
//NOTE: I DO NOT KNOW WHY THIS DOES NOT WORK ON GE SIT SERVER
...
/// + remove commmons.io.FileUtils dependency, use native file handling instead
...
public class jmte {
	...
	protected static class escapeHtml implements NamedRenderer {
		...
		@Override
		public String render(Object o, String format, Locale L) {
			return picoded.core.conv.StringEscape.escapeHtml((String) o);
		}
	}
	...
	protected static class encodeURI implements NamedRenderer {
		...
		@Override
		public String render(Object o, String format, Locale L) {
			return picoded.core.conv.StringEscape.encodeURI((String) o);
		}
	}
	...
	/// This was done as certain deployment enviroment has issues with the FileUtil
	...
	public String readFileToString(File inFile) throws IOException {
		return readFileToString(new FileReader(inFile));
	}
	
	public String readFileToString(FileReader fReader) throws IOException {
