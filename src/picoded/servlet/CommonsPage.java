...
public class CommonsPage extends BasePage {
	...
	public void initializeContext() throws Exception {
		...
		boolean ignorePageBuilder = JConfig().getBoolean("developersMode.PageBuilder_ignoreInitializeContext", false) || JConfig().getBoolean("developersMode.PagesBuilder_ignoreInitializeContext", false);
