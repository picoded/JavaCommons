...
public class NxtCrypt {
	...
	public static String getSaltedHash(String rawPassword, byte[] salt, int iteration, int keyLen) throws IllegalArgumentException, SecurityException {
		...
		SecretKey key;
		try {
			key = NxtCrypt.pbk.generateSecret(new PBEKeySpec(
																			 rawPassword.toCharArray(),
																			 salt, iteration, keyLen
																			 )
														 );
		} catch(Exception e) {
			throw new SecurityException(e);
	...
	public static String getSaltedHash(String rawPassword, String salt, int iteration, int keyLen) throws IllegalArgumentException, SecurityException {
	...
	public static String getSaltedHash(String rawPassword, byte[] salt) throws IllegalArgumentException, SecurityException {
	...
	public static String getSaltedHash(String rawPassword, String salt) throws IllegalArgumentException, SecurityException {
		return  getSaltedHash(rawPassword, salt, defaultIterations, defaultKeyLength);
	}
	...
	private static String getPassHash(String rawPassword, int saltLen, int iteration, int keyLen) throws IllegalArgumentException, SecurityException {
		if(saltLen <= 0) {
		...
		return Base64.encodeBase64String(salt)+seperator+"P"+iteration+"-"+keyLen+seperator+getSaltedHash(rawPassword, salt, iteration, keyLen);
	}
