...
public class SimpleShoppingCart {
	...
	/// @return The processed and validated `[[ID,count,meta], ... ]`
	///
	public GenericConvertList<List<Object>> mergeCartList(List<List<Object>> inBaseList, List<List<Object>> addList,
		boolean removeZeroCount) {
	...
	/// @return Returns a list as `[[ID,count], ... ]` in simple mode, else returns `[[ID,count,meta], ... ]`
	///
	public GenericConvertList<List<Object>> updateCartList(CorePage requestPage, List<List<Object>> addList,
		boolean simple) {
		// Get existing cart
	...
	/// @return Returns a list as `[[ID,count], ... ]` in simple mode, else returns `[[ID,count,meta], ... ]`
	///
	public GenericConvertList<List<Object>> replaceCartList(CorePage requestPage, List<List<Object>> cartList,
		boolean simple) {
		// Get existing cart
	...
	///
	public GenericConvertMap<String, Object> createPurchaseOrder(String purchaseOwnerID, List<List<Object>> cart,
		Map<String, Object> orderMeta, Map<String, Object> itemMeta, String status) {
