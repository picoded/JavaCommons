...
public class PageComponentFilter {
	...
	public String resolve(Document doc, String requestingRawPageName) throws IOException {
		resolveElements(doc.select("*"), requestingRawPageName);
		return doc.toString();
	}
	
	/// Filtering a html string, and resolving all the page component
	public String resolve(String inHTML, String requestingRawPageName) throws IOException {
		return resolve(Jsoup.parse(inHTML), requestingRawPageName);
	}
	
	/// Filtering a html string, and resolving all the page component
	public String resolveParts(String inHTML, String requestingRawPageName) throws IOException {
		return resolve(Jsoup.parseBodyFragment(inHTML), requestingRawPageName);
	}
	
	/// Process page elements
	protected void resolveElements(Elements eArr, String requestingRawPageName) throws IOException {
		for (Element e : eArr) {
	...
	protected String getRawComponentHtml(String rawPageName) throws IOException {
	...
	protected String getComponentHtml(String tagname) throws IOException {
