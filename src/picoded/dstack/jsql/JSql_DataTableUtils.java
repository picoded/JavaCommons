...
public class JSql_DataTableUtils {
	...
	public static Object[] valueToValueTypeSet(Object value) {
		...
		return valueTypeSet(MetaType.JSON.getValue(), null, null, jsonString.toString(),
			EmptyArray.BYTE);
	}
	...
	protected static StringBuilder complexQueryView(JSql sql, String tableName,
		Map<String, MetaType> mtm, List<Object> queryArgs) {
		//
	...
	public static String[] DataTableQuery_id( //
		...
		JSqlResult r = runComplexQuery(
			//
			DataTableObj, sql, tablename, "DISTINCT \"oID\"", whereClause, whereValues, orderByStr,
			offset, limit);
