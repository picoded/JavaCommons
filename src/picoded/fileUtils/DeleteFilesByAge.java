...
public class DeleteFilesByAge {
	...
	static public void olderThenUnixTimestamp(File fileObj, long olderThenUnixTimestamp ) {
		...
		} else if(fileObj != null && (fileObj.lastModified() / 1000L) <= olderThenUnixTimestamp) { //actual deleting?
			fileObj.delete();
		}
	}
	...
	///
	/// @param   fileObj        File object, that is scanned as a directory / deleted as a file
	/// @param   ageInSeconds   The age in seconds, that the file must be to be deleted
