...
public class Base62_test {
	...
	public void base64_encodeAndDecodeOnce() {
		...
		assertArrayEquals("For encoded string: " + b64str, byteArr,
				Base64.decodeBase64(b64str));
		assertArrayEquals("For encoded string: " + bXstr, byteArr,
				b.decode(bXstr));
	}
	...
	public void base64_edgeCases() {
		...
		for (int a = 0; a < edgeCases.length; ++a) {
			...
			assertArrayEquals("For encoded string: " + edgeCases[a], byteArr,
					b.decode(edgeCases[a]));
