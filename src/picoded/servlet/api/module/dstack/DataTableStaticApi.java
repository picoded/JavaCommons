 ...
 * 
 * NOTE: These static functions are not designed to do argument
 * validation, as it is assumed to be done by the api function.
 */
public class DataTableStaticApi {
	 ...
	 * 
	 * @param  res      result object map to populate and return
	 * @param  dTable   DataTable object to use
	 * @param  newData  new meta data to populate the object
	 */
	public static <T extends GenericConvertMap<String,Object>> T newEntry(
		T resObj,
		DataTable dTable,
