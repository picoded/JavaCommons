...
public class GenericConvertArrayList<E> extends ArrayList<E> implements
		GenericConvertList<E> {
	...
	/**
	 * Trims the capacity of this <tt>GenericConvertArrayList</tt> instance to
	 * be the list's current size. An application can use this operation to
	 * minimize the storage of an <tt>GenericConvertArrayList</tt> instance.
	 */
	...
	/**
	 * Increases the capacity of this <tt>GenericConvertArrayList</tt> instance,
	...
	/**
	 * Returns a shallow copy of this <tt>GenericConvertArrayList</tt> instance.
	 * (The elements themselves are not copied.)
	 *
	 * @return a clone of this <tt>GenericConvertArrayList</tt> instance
	 */
	public Object clone() {
		@SuppressWarnings("unchecked")
		GenericConvertArrayList<E> v = (GenericConvertArrayList<E>) super
				.clone();
	...
	/**
	 * Save the state of the <tt>GenericConvertArrayList</tt> instance to a
	 * stream (that is, serialize it).
	 *
	 * @serialData The length of the array backing the
	 *             <tt>GenericConvertArrayList</tt> instance is emitted (int),
	...
	/**
	 * Reconstitute the <tt>GenericConvertArrayList</tt> instance from a stream
	...
	private class Itr implements Iterator<E> {
		...
		public E next() {
			...
			Object[] elementData = GenericConvertArrayList.this.elementData;
		...
		public void remove() {
			...
			try {
				GenericConvertArrayList.this.remove(lastRet);
				cursor = lastRet;
				lastRet = -1;
	...
	private class ListItr extends Itr implements ListIterator<E> {
		...
		public void set(E e) {
			...
			try {
				GenericConvertArrayList.this.set(lastRet, e);
			} catch (IndexOutOfBoundsException ex) {
				throw new ConcurrentModificationException();
			}
		}
		...
		public void add(E e) {
			...
			try {
				int i = cursor;
				GenericConvertArrayList.this.add(i, e);
				cursor = i + 1;
				lastRet = -1;
				expectedModCount = modCount;
			} catch (IndexOutOfBoundsException ex) {
	...
	private class SubList extends AbstractList<E> implements RandomAccess {
		...
		SubList(AbstractList<E> parent, int offset, int fromIndex, int toIndex) {
			...
			this.modCount = GenericConvertArrayList.this.modCount;
		}
		...
		public ListIterator<E> listIterator(final int index) {
			...
			return new ListIterator<E>() {
				int cursor = index;
				int lastRet = -1;
				int expectedModCount = GenericConvertArrayList.this.modCount;
				...
				public void remove() {
					...
					try {
						...
						cursor = lastRet;
						lastRet = -1;
						expectedModCount = GenericConvertArrayList.this.modCount;
					} catch (IndexOutOfBoundsException ex) {
						throw new ConcurrentModificationException();
					}
				}
				...
				public void set(E e) {
					...
					try {
						GenericConvertArrayList.this.set(offset + lastRet, e);
					} catch (IndexOutOfBoundsException ex) {
						throw new ConcurrentModificationException();
					}
				}
				...
				final void checkForComodification() {
					if (expectedModCount != GenericConvertArrayList.this.modCount)
						throw new ConcurrentModificationException();
				}
			};
		}
		...
		private void checkForComodification() {
			if (GenericConvertArrayList.this.modCount != this.modCount)
				throw new ConcurrentModificationException();
		}
