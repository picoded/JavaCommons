...
public class RancherObject {
	 ...
	 */
	public GenericConvertMap<String, Object> generateStackPostData(
		GenericConvertMap<String, Object> userInfo) {
	 ...
	 */
	public GenericConvertMap<String, Object> createStack(
		GenericConvertMap<String, Object> stackConfig) {
	 ...
	 * @return the result of the connection
	 */
	private GenericConvertMap<String, Object> setAndSendRequest(String url, String requestMethod,
		byte[] dataBytes) {
		...
		try {
			...
			result.put("code",
				"Connection error while passing data to rancher. Review RancherObject. Request Method used: "
					+ requestMethod);
		}
