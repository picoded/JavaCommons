...
public class PDFGenerator {
	...
	public static boolean generateDFfromRawHTML_embeddedImageSupport(String outputpdfpath,
		...
		try {
			...
			sharedContext
				.setReplacedElementFactory(new picoded.util.file.B64ImgReplacedElementFactory());
