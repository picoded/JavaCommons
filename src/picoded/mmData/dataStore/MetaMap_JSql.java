...
///
/// Do note, while database structure has provisioning made for usage as a multimap,
/// Such usage is not actually implemented by MetaMap currently (maybe in the future?)
///
/// *******************************************************************************
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~{.java}
...
public class MetaMap_JSql /*implements Map<String, Map<String,Object>>*/{
	...
	public MetaMap_JSql clearExpiredValues() throws JSqlException {
